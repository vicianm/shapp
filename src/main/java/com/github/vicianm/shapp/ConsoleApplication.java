...
public class ConsoleApplication {
        ...
        while (true) {
            ...
            for (int i = 0; i < methods.size(); i++) {
                ...
                if (command.equals(m.getName())) {
                    ...
                    ConsoleMethod cm = m.getAnnotation(ConsoleMethod.class);
        ...
        for (Method m : getClass().getMethods()) {
            ...
            if (cm != null) {
                ...
                if (cm.params().length != m.getParameterTypes().length) {
                    throw new RuntimeException("Invalid length of [params] field of [" + ConsoleMethod.class.getSimpleName() + "] " +
    ...
    @ConsoleMethod(description = "prints this help")
    public void help() {
    ...
    @ConsoleMethod(description = "exits the application")
    public void exit() {
